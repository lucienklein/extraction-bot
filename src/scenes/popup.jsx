  ...
  return (
    <div className="tailwind">
      <button
        ...
        className="rounded-md bg-[#026D77] px-3.5 py-2.5 text-2xl font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2  bottom-3 right-4 fixed z-40"
      >
        {buttonText}
      </button>
      {displayFiles && (
