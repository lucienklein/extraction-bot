  ...
  return (
    <div className="tailwind">
      <button
        ...
        className="rounded-md bg-[#026D77] px-3.5 py-2.5 text-2xl font-semibold text-white shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 z-40"
      >
        <svg
